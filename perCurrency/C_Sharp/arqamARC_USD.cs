/**************************************************************************************
* @function      : arqamARC_USD(Number)
* @purpose       : C# function to convert Numbers to US Dollars Currency in Arabic Words
...
{  // =============== Tests ===============
    Console.WriteLine(arqamARC_USD(""));
    Console.WriteLine(arqamARC_USD("0"));
    Console.WriteLine(arqamARC_USD("0.01"));
    Console.WriteLine(arqamARC_USD("0.02"));
    Console.WriteLine(arqamARC_USD("0.11"));
    Console.WriteLine(arqamARC_USD("0.12"));
    Console.WriteLine(arqamARC_USD("0.21"));
    Console.WriteLine(arqamARC_USD("0.21"));
    Console.WriteLine(arqamARC_USD("1"));
    Console.WriteLine(arqamARC_USD("2"));
    Console.WriteLine(arqamARC_USD("3"));
    Console.WriteLine(arqamARC_USD("8"));
    Console.WriteLine(arqamARC_USD("10"));
    Console.WriteLine(arqamARC_USD("11"));
    Console.WriteLine(arqamARC_USD("12.11"));
    Console.WriteLine(arqamARC_USD("13.14"));
    Console.WriteLine(arqamARC_USD("17.18"));
    Console.WriteLine(arqamARC_USD("22.45"));
    Console.WriteLine(arqamARC_USD("100"));
    Console.WriteLine(arqamARC_USD("100.45"));
    Console.WriteLine(arqamARC_USD("200"));
    Console.WriteLine(arqamARC_USD("200.45"));
    Console.WriteLine(arqamARC_USD("532"));
    Console.WriteLine(arqamARC_USD("1000"));
    Console.WriteLine(arqamARC_USD("2000"));
    Console.WriteLine(arqamARC_USD("1000000"));
    Console.WriteLine(arqamARC_USD("200000"));
    Console.WriteLine(arqamARC_USD("2000000"));
    Console.WriteLine(arqamARC_USD("818.18"));
    Console.WriteLine(arqamARC_USD("878799987998787878787.09"));
}


//*==============================================
//*         arqamARC_USD Function Start
//*==============================================
public static string arqamARC_USD(String NumIn)
//*==============================================
{
    ...
    Triplet = Triplet % 100;
    string CurrencyName = space + (hasDecimal ? "سنت":"دولار أمريكي");            // Singular Currency Name
    if (Triplet > 10)  return space + (hasDecimal ? "سنتاً":"دولاراً أمريكياً");     // Currency Tanween
    if (Triplet > 2)   return space + (hasDecimal ? "سنتات":"دولارات أمريكية");    // Plural Currency
    if (Triplet ==2)   return (hasDecimal ? "سنتان":"دولاران أمريكيان")+" اثنان"; // Double Currency
    if (Triplet ==1)   return (hasDecimal ?"سنت":"دولار أمريكي")+" واحد";        // One Currency
    return CurrencyName;
    }
