/**************************************************************************************
* @function      : arqamARC_KWD(Number)
* @purpose       : C# function to convert Numbers to Kuwait Dinar Currency in Arabic Words
...
{  // =============== Tests ===============
    Console.WriteLine(arqamARC_KWD(""));
    Console.WriteLine(arqamARC_KWD("0"));
    Console.WriteLine(arqamARC_KWD("0.01"));
    Console.WriteLine(arqamARC_KWD("0.02"));
    Console.WriteLine(arqamARC_KWD("0.11"));
    Console.WriteLine(arqamARC_KWD("0.12"));
    Console.WriteLine(arqamARC_KWD("0.21"));
    Console.WriteLine(arqamARC_KWD("0.21"));
    ...
    Console.WriteLine(arqamARC_KWD("13.14"));
    Console.WriteLine(arqamARC_KWD("17.18"));
    Console.WriteLine(arqamARC_KWD("22.45"));
    Console.WriteLine(arqamARC_KWD("100"));
    Console.WriteLine(arqamARC_KWD("100.45"));
    Console.WriteLine(arqamARC_KWD("200"));
    Console.WriteLine(arqamARC_KWD("200.45"));
    ...
    Console.WriteLine(arqamARC_KWD("818.18"));
    Console.WriteLine(arqamARC_KWD("878799987998787878787.09"));
}


//*==============================================
//*         arqamARC_KWD Function Start
//*==============================================
public static string arqamARC_KWD(String NumIn)
//*==============================================
{
    ...
    int Triplet=0, currencyDigits = 3;                                   // number of digits for the currency (i.e. sub unit) change for others e.g. 2 for US Dollars
    ...
    Triplet = Triplet % 100;
    string CurrencyName = space + (hasDecimal ? "فلس":"دينار كويتي");            // Singular Currency Name
    if (Triplet > 10)  return space + (hasDecimal ? "فلساً":"ديناراً كويتياً");     // Currency Tanween
    if (Triplet > 2)   return space + (hasDecimal ? "فلوس":"دنانير كويتية");    // Plural Currency
    if (Triplet ==2)   return (hasDecimal ? "فلسان":"ديناران كويتيان")+" اثنان"; // Double Currency
    if (Triplet ==1)   return (hasDecimal ?"فلس":"دينار كويتي")+" واحد";        // One Currency
    return CurrencyName;
    }
