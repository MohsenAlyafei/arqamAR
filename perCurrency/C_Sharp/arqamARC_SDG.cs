...
{  // =============== Tests ===============
    Console.WriteLine(arqamARC_SDG(""));
    Console.WriteLine(arqamARC_SDG("0"));
    Console.WriteLine(arqamARC_SDG("0.01"));
    Console.WriteLine(arqamARC_SDG("0.02"));
    Console.WriteLine(arqamARC_SDG("0.11"));
    Console.WriteLine(arqamARC_SDG("0.12"));
    Console.WriteLine(arqamARC_SDG("0.21"));
    Console.WriteLine(arqamARC_SDG("0.21"));
    Console.WriteLine(arqamARC_SDG("1"));
    Console.WriteLine(arqamARC_SDG("2"));
    Console.WriteLine(arqamARC_SDG("3"));
    Console.WriteLine(arqamARC_SDG("10"));
    Console.WriteLine(arqamARC_SDG("11"));
    Console.WriteLine(arqamARC_SDG("12.11"));
    Console.WriteLine(arqamARC_SDG("22.45"));
    Console.WriteLine(arqamARC_SDG("100"));
    Console.WriteLine(arqamARC_SDG("100.45"));
    Console.WriteLine(arqamARC_SDG("200"));
    Console.WriteLine(arqamARC_SDG("200.45"));
    Console.WriteLine(arqamARC_SDG("532"));
    Console.WriteLine(arqamARC_SDG("1000"));
    Console.WriteLine(arqamARC_SDG("2000"));
    Console.WriteLine(arqamARC_SDG("1000000"));
    Console.WriteLine(arqamARC_SDG("200000"));
    Console.WriteLine(arqamARC_SDG("2000000"));
    Console.WriteLine(arqamARC_SDG("818.18"));
    Console.WriteLine(arqamARC_SDG("878799987998787878787.09"));
}


//============================================================================================================
public static string arqamARC_SDG(String NumIn)
//============================================================================================================
{
    ...
    Triplet = Triplet % 100;
    string SubjectName = space + (hasDecimal ? "قرش":"جنيه سوداني");               // Default Subject Name is at Pos 1
    if (Triplet > 10)  return space + (hasDecimal ? "قرشاً":"جنيهاً سودانياً");     // Subject name with Tanween for 11-99
    if (Triplet > 2)   return space + (hasDecimal ? "قروش":"جنيهات سودانية");    // Subject name Plural for 3-10
    if (Triplet ==2)   return (hasDecimal ? "قرشان":"جنيهان سودانيان")+" اثنان"; // Reverse names for 2
    if (Triplet ==1)   return (hasDecimal ?"قرش":"جنيه سوداني")+" واحد";        // Reverse names for 1
